...
class Contact:
    ...
    def __eq__(self, other):
        return (self.id is None or other.id is None or self.id == other.id) and ' '.join(self.firstname.split()) == ' '.join(other.firstname.split()) and ' '.join(self.lastname.split()) == ' '.join(other.lastname.split())
